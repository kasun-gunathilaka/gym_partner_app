...
import com.kasungunathilaka.showcase.shape.NoShape;
import com.kasungunathilaka.showcase.shape.RectangleShape;
import com.kasungunathilaka.showcase.shape.Shape;
import com.kasungunathilaka.showcase.target.MenuViewTarget;
import com.kasungunathilaka.showcase.target.Target;
import com.kasungunathilaka.showcase.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.showcase_layout, this, true);
        ll = contentView.findViewById(R.id.ll);
        tvTitle = (TextView) contentView.findViewById(R.id.tvTitle);
        tvDescription = (TextView) contentView.findViewById(R.id.tvDescription);
        tvDismiss = (TextView) contentView.findViewById(R.id.tvDismiss);
    ...
    private void applyLayoutParams() {
        ...
        if (ll != null && ll.getLayoutParams() != null) {
            FrameLayout.LayoutParams contentLP = (LayoutParams) ll.getLayoutParams();
    ...
    private void setTitleText(CharSequence contentText) {
        if (tvTitle != null && !contentText.equals("")) {
            tvDescription.setAlpha(0.5F);
            tvTitle.setText(contentText);
        }
    }

    private void setContentText(CharSequence contentText) {
        if (tvDescription != null) {
            tvDescription.setText(contentText);
        }
    }
    ...
    private void setContentTextColor(int textColour) {
        if (tvDescription != null) {
            tvDescription.setTextColor(textColour);
        }
    }

    private void setDismissTextColor(int textColour) {
        if (tvDismiss != null) {
            tvDismiss.setTextColor(textColour);
        }
    }
    ...
    private void updateDismissButton() {
        // hide or show button
        if (tvDismiss != null) {
            if (TextUtils.isEmpty(tvDismiss.getText())) {
                tvDismiss.setVisibility(GONE);
            } else {
                tvDismiss.setVisibility(VISIBLE);
            }
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setTarget(View target,String menu) {
            showcaseView.setTarget(new MenuViewTarget(target));
            return this;
        }
